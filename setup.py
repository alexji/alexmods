...
version = vre.findall(read(path.join(here, "alexmods", "__init__.py")))[0]
...
setup(
    ...
    description="Alex Ji Science Modules",
    long_description=read(path.join(here, "README.md")),
    url="https://github.com/alexji/alexmods",
    license="MIT",
    classifiers=[
